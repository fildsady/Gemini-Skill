...
2. Structure & Spacing: Keep the structure of the song line-by-line. Follow this exact template for each line of the song:
   ...
   [Romanized Line] (แยกออกเป็นอีกบรรทัดใหม่โดยเว้นบรรทัดว่างคั่นกลางระหว่างบรรทัดภาษาเดิม - เฉพาะภาษาที่ไม่ใช่อังกฤษ เช่น Romaji สำหรับญี่ปุ่น, Pinyin สำหรับจีน, RR สำหรับเกาหลี)
...
2. Romanization (สำหรับภาษาที่ไม่ใช่อังกฤษ):
   - **ภาษาญี่ปุ่น:** ต้องมีคำอ่านภาษาอังกฤษแบบโรมาจิ (Romaji) แยกบรรทัดโดยมีบรรทัดว่างคั่นเสมอ
   - **ภาษาจีน:** ต้องมีคำอ่านภาษาอังกฤษแบบพินอิน (Pinyin) แยกบรรทัดโดยมีบรรทัดว่างคั่นเสมอ
   - **ภาษาเกาหลี:** ต้องมีคำอ่านภาษาอังกฤษแบบโรมัน (Romanization) แยกบรรทัดโดยมีบรรทัดว่างคั่นเสมอ
