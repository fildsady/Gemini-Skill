...
2. Structure & Spacing: Keep the structure of the song line-by-line. Follow this exact template for each line of the song:
   ...
   [Original Line]
   [Romanized Line] (แยกออกเป็นอีกหนึ่งบรรทัดใหม่ทันทีใต้บรรทัดภาษาเดิม - เฉพาะภาษาที่ไม่ใช่อังกฤษ เช่น Romaji สำหรับญี่ปุ่น, Pinyin สำหรับจีน, RR สำหรับเกาหลี)
...
2. Romanization (สำหรับภาษาที่ไม่ใช่อังกฤษ):
   - **ภาษาญี่ปุ่น:** ต้องมีคำอ่านภาษาอังกฤษแบบโรมาจิ (Romaji) แยกเป็นอีกบรรทัดหนึ่งเสมอ
   - **ภาษาจีน:** ต้องมีคำอ่านภาษาอังกฤษแบบพินอิน (Pinyin) แยกเป็นอีกบรรทัดหนึ่งเสมอ
   - **ภาษาเกาหลี:** ต้องมีคำอ่านภาษาอังกฤษแบบโรมัน (Romanization) แยกเป็นอีกบรรทัดหนึ่งเสมอ
