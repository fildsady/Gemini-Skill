...
$folders = @("default_rules", "grill_me", "po_pdf", "novel_translator", "tech_translator", "song_translator", "thai_tech_writer", "av_embedded_planner", "stm32_libopencm3_troubleshoot")
